    ...
    for epoch in range(epochs + 1):
        for batch in range(x_train.shape[0] // batch_size):
            ...
            if batch % sample_interval == 0:
                ...
                generator.save_weights(f"{models_dir}/generator{epoch}.weights.h5")
                discriminator.save_weights(f"{models_dir}/discriminator{epoch}.weights.h5")
                gan.save_weights(f"{models_dir}/gan{epoch}.weights.h5")
